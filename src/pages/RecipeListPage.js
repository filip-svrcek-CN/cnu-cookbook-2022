...
export function RecipeListPage() {
  ...
  return (
    <Container>
      <h1>Recepty</h1>
      <Link to={`/novy-recept`}>
        <Button block color="primary" style={{ marginBottom: '12px' }}>
          Nový recept
        </Button>
      </Link>
      <SearchInput
      ...
      <div className="sortRecipeList">
        <Label style={{ margin: '0px 10px 0px 0px', paddingTop: '7px' }}>
          Seřadit:{' '}
        </Label>
        <Input
          style={{ width: '170px' }}
        ...
        >
          ...
          <option value="preparationTime">Čas na přípravu</option>
        </Input>
      </div>
